...
<<<<<<< HEAD
        ...
        items.Add(new Item(name: "Mobile Phone", id: 3, desc: "Mobile Phone", type: Item.ItemType.Drink, destroy: false, quantity: 0, cost: 0));
...
=======
        ...
        items.Add(new Item(name: "Red T-Shirt", id: 4, desc: "Classic Red T-Shirt", type: Item.ItemType.Clothes, destroy: false, quantity: 0));
